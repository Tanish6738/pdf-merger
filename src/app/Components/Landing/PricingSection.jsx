      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold text-theme-text mb-6">
            Simple, Transparent <span className="text-theme-primary">Pricing</span>
          </h2>
          ...
          {/* Billing toggle */}
          <div className="mx-auto flex w-1/3 gap-4 justify-around items-center bg-theme-secondary border border-theme-border rounded-lg p-1">
            <button
              onClick={() => handleBillingToggle("monthly")}
              className={`px-4 py-2 w-1/2 rounded-md font-medium transition-colors ${
          ...
          {plans.map((plan, index) => (
            <motion.div
              key={index}
              className={`relative card-theme p-8 transition-all duration-300 ${
                plan.popular
                  ? "border-theme-primary shadow-lg shadow-theme-primary scale-105"
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-theme-text-secondary mb-4">{plan.description}</p>

                <div className="flex items-baseline justify-center mb-2">
                  <span className="text-4xl lg:text-5xl font-bold text-theme-text">
                    {getPlanPrice(plan).price}
                  </span>
                  <span className="text-theme-text-secondary ml-1">
                    {getPlanPrice(plan).period}
                  </span>
                </div>                {billingPeriod === "annual" && plan.name !== "Enterprise" && (
              ...
              <ul className="space-y-4 mb-8">                {plan.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-start space-x-3">
                    <div className="w-5 h-5 bg-theme-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg
        ...
        >          <div className="card-theme p-8 max-w-4xl mx-auto">
            ...
            </p>            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-theme-primary rounded-full flex items-center justify-center mb-3">
                  <svg
